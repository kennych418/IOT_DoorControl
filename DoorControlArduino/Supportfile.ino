...
void boardConfig(void)
{
  ...
  boardA.setOCThreshold(OC_6000mA);  // OC threshold 2250mA
  ...
  boardA.setAccKVAL(20);           // We'll tinker with these later, if needed.
  boardA.setDecKVAL(20);
